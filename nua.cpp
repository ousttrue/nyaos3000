...
static int extended_ipairs(lua_State *L)
{
    if( lua_getmetatable(L,-1) ){
...
int NyaosLua::init()
{
    if( ! initialized ){
        ...
        /* extended ipairs function */
        lua_getglobal(L,"ipairs");
        lua_setglobal(L,"__rawipair__");
        lua_pushcfunction(L,extended_ipairs);
